...
cmd.AREA_LONG					= 0									--龙胜索引
cmd.AREA_PING					= 1									--平家索引
cmd.AREA_FENG					= 2									--凤胜索引

cmd.AREA_MAX					= 3									--最大区域

--区域倍数multiple
cmd.MULTIPLE_LONG				= 2									--龙胜倍数
cmd.MULTIPLE_PING				= 10								--平家倍数
cmd.MULTIPLE_FENG				= 2									--凤胜倍数
...
cmd.CMD_S_StatusFree = 
{
	...
	--作弊控制
    {k = "cbArea", t = "byte", l = {cmd.AREA_MAX}}, 
...
cmd.tagArea = 
{
	{k = "AreaBet", t = "double", l = {cmd.AREA_MAX}}, 
}
--游戏状态 play/jetton
cmd.CMD_S_StatusPlay = 
{
    ...
    {k = "lAndroidBet", t = "double", l = {cmd.AREA_MAX}},	--机器人下注
	{k = "lPlayerAreaBet", t = "table", d = cmd.tagArea, l = {cmd.GAME_PLAYER}},	--真人每个区域下注
	{k = "dwGameID", t = "dword", l = {cmd.GAME_PLAYER}},	--玩家id
	{k = "lPlayerTotleBet", t = "double", l = {cmd.GAME_PLAYER}},	--每个人总下注
    ...
    {k = "cbTableCardArray", t = "byte", l = {1,1}},	--桌面扑克 2,3
   ...
   -- 占位椅子id MAX_OCCUPY_SEAT_COUNT
	...
	--输赢区域
	{k = "cbWinArea",t = "byte", l = {cmd.AREA_MAX}},
	{k = "lBottomPourImpose", t = "double"},							--下注限制
    {k = "CustomAndroid", t = "table", d = cmd.tagCustomAndroid} --机器人配置
...
cmd.CMD_C_AdminReq = 
{
	...
	{k = "bWinArea", t = "byte", l = {cmd.AREA_MAX}},	
}
cmd.RES_PATH 					= 	"longfengdou/res/"
