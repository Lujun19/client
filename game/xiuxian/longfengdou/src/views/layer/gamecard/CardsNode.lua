...
--
local CardSprite = require("game.xiuxian.longfengdou.src.views.layer.gamecard.CardSprite")
...
function CardsNode:updateCardsNode( cards, isShowCard, bAnimation, pCallBack)
	...
	for i=1,m_cardCount do
		...
		print("扑克数据1111111m_cardsData[i]----",m_cardsData[i]);
...
function CardsNode:addCards(cbCard, pCallBack)
	...
	for i=1,total do
		print("扑克数据333333----",self.m_cardsData[i]);
	end
