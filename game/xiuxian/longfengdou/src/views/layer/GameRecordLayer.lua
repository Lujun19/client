...
function GameRecordLayer:refreshRecordList(  )
	...
	for i=nTotal,1,-1 do
		...
		elseif cmd.AREA_PING == newRec.m_cbGameResult then
			str1 = "record/dragon_charts_wan_blue.png"
			str2 = "record/dragon_charts_wan_blue.png"
