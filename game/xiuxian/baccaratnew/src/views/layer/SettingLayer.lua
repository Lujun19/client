...
function SettingLayer:ctor( )
	...
	--游戏版本号
	self.m_gameVersion = sp_bg:getChildByName("Text_version")
	self.m_gameVersion:setString("")
...
function SettingLayer:setVersion( version )
	self.m_gameVersion:setString(version)
end
