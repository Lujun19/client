...
local UserListItem = appdf.req(appdf.GAME_SRC.."yule.redninebattle.src.views.layer.UserListItem")
...
function UserListLayer:showLayer()
	self:setVisible(true)
	self.m_spBg:setPositionY(1022)
	self.m_spBg:runAction(cc.MoveTo:create(0.17, cc.p(self.m_spBg:getPositionX(), 465)))
end
