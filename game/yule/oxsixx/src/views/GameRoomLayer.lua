...
function GameRoomLayer:getTableParam(frameEngine)
    local table_bg = cc.Sprite:create("game/yule/oxsixx/res/roomlist/roomtable.png")
    ...
    elseif chairCount == 5 then
        tabPos = {cc.p(-50,100), cc.p(107,246), cc.p(266,100), cc.p(107,-56),cc.p(50,-56)}
    elseif chairCount == 6 then
        tabPos = {cc.p(40,224),cc.p(138,224),cc.p(234,224),cc.p(234,-36),cc.p(138,-36),cc.p(40,-36)}
    end
