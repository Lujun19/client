...
function SettingLayer:ctor( )
    ExternalFun.registerTouchEvent(self, true)--注册触摸事件
    self._csbNode = ExternalFun.loadCSB("set/set.csb", self)--加载csb资源
    ...
    self.m_spBg = self._csbNode:getChildByName("bg") --背景
