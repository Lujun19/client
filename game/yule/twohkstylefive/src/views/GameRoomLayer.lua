...
function GameRoomLayer:getTableParam()
    ...
    local table_bg = cc.Sprite:create("game/yule/twohkstylefive/res/roomlist/roomtable.png")
    ...
    return table_bg, {cc.p(70,140),cc.p(1630,2204),cc.p(265,180),cc.p(2100,-3600),cc.p(1200,-3600)}
end
