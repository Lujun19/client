...
cmd.SUB_S_AMDIN_COMMAND     	= 110                 				--管理员命令
...
cmd.CMD_S_StatusFree =
{
	...
	{k = "cbArea", t = "byte", l = {4}}, 
	{k = "cbControlStyle", t = "byte"},	
	{k = "bControlLimits", t = "bool"},							--控制权限							
	--控制信息
...
cmd.CMD_C_AdminReq = 
{
	...
	{k = "cbExtendData", t = "byte", l = {14}},			 --附加数据		
}
cmd.CMD_C_peizhiVec=
{
	 {k = "dwGameID", t = "dword"},
