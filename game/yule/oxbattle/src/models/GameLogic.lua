...
function GameLogic:getMultiple( cbTypeVale )
	local iMultiple = 0
	if cbTypeVale >= self.BRNN_CT_SPECIAL_NIUYING then
		iMultiple = 5
	elseif cbTypeVale >= self.BRNN_CT_SPECIAL_NIUNIU  then
		iMultiple = 4
	elseif cbTypeVale == self.BRNN_CT_SPECIAL_NIU9  then
		iMultiple = 3
	elseif cbTypeVale >= self.BRNN_CT_SPECIAL_NIU7  then
		iMultiple = 2
	else
		iMultiple = 1
	end
