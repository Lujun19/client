...
function ClientSceneMediator:checkGameUpdate(e, kinid)
  ...
  local jsonStr = cjson.encode(version)
	LogAsset:getInstance():logData(cjson.encode(version),true)
...
function ClientSceneMediator:onEnterGame(gameinfo, isUpdate)
  ...
  LogAsset:getInstance():logData("onEnterGame",true)
 	LogAsset:getInstance():logData(cjson.encode(gameinfo),true)
    ...
    LogAsset:getInstance():logData("roomCount==", true)
    LogAsset:getInstance():logData(cjson.encode(roomCount), true)
