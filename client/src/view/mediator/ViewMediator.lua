...
--[[		if (type(msgData) == "table") then
		...
		elseif (msgType == VIEW_LIST.KEFU_LAYER) then
			mediatorClass = nil --require("client.src.view.mediator.EarnMediator")
			viewClass = require("client.src.plaza.views.layer.plaza.KeFuLayer")
		elseif (msgType == VIEW_LIST.DUIHUAN_LAYER) then
			mediatorClass = require("client.src.plaza.mediator.ExchangeMediator")
			-- viewClass = require("client.src.plaza.views.layer.plaza.DuiHuanLayer")
			-- viewClass = require("client.src.plaza.views.layer.plaza.DuiHuanLayer")
			-- mediatorClass = nil --require("client.src.view.mediator.EarnMediator")
			viewClass = require("client.src.plaza.views.layer.plaza.DuiHuanLayer")
