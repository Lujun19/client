...
--测试
yl.LOGONSERVER							="116.31.99.118"--"game.miankee.top"--"47.99.108.20"--"103.53.127.72"--"103.60.167.154"--"game.beiyoub.top"----"47.107.119.160"------"game.yoohg.xyz"
--正式
--yl.LOGONSERVER							= "1.32.255.107"--"game.miankee.top"--"47.99.108.20"--"103.53.127.72"--"103.60.167.154"--"game.beiyoub.top"----"47.107.119.160"------"game.yoohg.xyz"
--yl.LOGONSERVER							="192.168.1.104"--"game.miankee.top"--"47.99.108.20"--"103.53.127.72"--"103.60.167.154"--"game.beiyoub.top"----"47.107.119.160"------"game.yoohg.xyz"
...
--yl.PAY_SERVER ="http://103.53.127.61:11111"
--http://www.fuannabbs.top:8099
yl.PAY_SERVER ="http://www.fuannainc.top:8099"
--yl.PAY_SERVER ="http://www.fuannainc.top:8099"
yl.GAME_SHISHICAI ="http://pay.daoen1kj.cn:37952"
-- 当前地址索引
yl.CURRENT_INDEX = 1
...
yl.PAYMENT_ALIPAY_DAI		= 2001	--支付宝支付渠道
...
yl.PAYMENT_WF_WZF          = 101  --QQ钱包T1
yl.PAYMENT_WF_WX          = 102  --QQ钱包T1
yl.PAYMENT_WF_YX          = 103  --QQ钱包T1
...
yl.SocialShare =
{
	title 								= "E发娱乐等你来", --@share_title_social
	content 							= "E发娱乐旗舰版,不一样的体验",
...
--  wxb39718a5afd0be83
-- AppSecret:
--  04934685044dbee79bbacb9024ec529f
--  复制
...
yl.WeChat =
{
	AppID 								= "wxb39718a5afd0be83", --@wechat_appid_wx
	AppSecret 							= "04934685044dbee79bbacb9024ec529f", --@wechat_secret_wx
	-- 商户id
...
--
-- <add key="DBNativeWeb" value="Data Source=1.32.255.107; Initial Catalog=RYNativeWebDB; User ID=sa; Password=918@moxienewpoke; Pooling=true" />
--   <add key="DBAccounts" value="Data Source=1.32.255.107; Initial Catalog=RYAccountsDB; User ID=sa; Password=918@moxienewpoke; Pooling=true" />
--   <add key="DBPlatform" value="Data Source=1.32.255.107; Initial Catalog=RYPlatformDB; User ID=sa; Password=918@moxienewpoke; Pooling=true" />
--   <add key="DBTreasure" value="Data Source=1.32.255.107; Initial Catalog=RYTreasureDB; User ID=sa; Password=918@moxienewpoke; Pooling=true" />
--   <add key="DBRecord" value="Data Source=1.32.255.107; Initial Catalog=RYRecordDB; User ID=sa; Password=918@moxienewpoke; Pooling=true" />
--   <add key="DBGameMatch" value="Data Source=1.32.255.107; Initial Catalog=RYGameMatchDB; User ID=sa; Password=918@moxienewpoke; Pooling=true" />
